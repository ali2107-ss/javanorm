...
/**
 * Правило №1: Проверка структуры документа — наличие обязательных
 * разделов по ГОСТ 19.201-78.
 * <p>
 * Проверяемые разделы (п.2 ГОСТ 19.201-78):
 * <ul>
 *   <li>Введение (п.2.1)</li>
 *   <li>Основания для разработки (п.2.2)</li>
 *   <li>Назначение разработки (п.2.3)</li>
 *   <li>Требования к программному изделию (п.2.4)</li>
 *   <li>Требования к программной документации (п.2.5)</li>
 *   <li>Стадии и этапы разработки (п.2.7)</li>
 *   <li>Порядок контроля и приёмки (п.2.8)</li>
 * </ul>
 * </p>
 */
@Slf4j
@Component
public class StructureCheckRule implements CheckRule {

    /** Обязательные разделы: название → (ключевые слова, код правила, ссылка на ГОСТ). */
    ...
    /**
     * {@inheritDoc}
     * <p>Проверяет наличие всех обязательных разделов и подразделов в заголовках документа.</p>
     */
    @Override
    public List<Violation> check(XWPFDocument document) {
        ...
        // ── Проверка подразделов «Требования к программному изделию» ───────
        ...
        log.info("StructureCheckRule: обнаружено {} нарушений", violations.size());
        return violations;
    }
    ...
    /**
     * Найти номер строки (параграфа), содержащей одно из ключевых слов.
     */
    ...
    private record RequiredSection(String code, String name, List<String> keywords, String gostRef) {}
}
